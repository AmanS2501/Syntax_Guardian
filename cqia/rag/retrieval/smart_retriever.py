# """
# Smart retriever that respects file boundaries and prioritizes path/function name matches.
# """
...
#     def __init__(self, vector_store, k: int = 5, name_match_boost: float = 0.3):
#         super().__init__()
#         self.vector_store = vector_store
#         self.k = k
#         self.name_match_boost = float(name_match_boost)
...
#             for t in tokens:
#                 if t in name:
#                     adj += self.name_match_boost
#                 if t in fname:
#                     adj += self.name_match_boost * 0.5
